...
"</a>"+
"</li>";jQuery("#live-search_val").html("<ul>"+loading+"</ul>");var pos=this.bounds(elem,options);var containerPos=this.bounds('.searchx',options);if(!pos){jQuery("#live-search_sb").hide();return false;}
